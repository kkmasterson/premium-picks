...
const ProfilePage = lazyNamed(() => import('@/features/dashboard/pages/ProfilePage'), 'ProfilePage');
const CalculatorsPage = lazyNamed(() => import('@/features/dashboard/pages/ToolsPages'), 'CalculatorsPage');
const GuidesPage = lazyNamed(() => import('@/features/dashboard/pages/ToolsPages'), 'GuidesPage');
