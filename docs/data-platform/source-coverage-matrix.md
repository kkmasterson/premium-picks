...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Sport and competition identity/media | IDN-001–004, IDN-015 | Critical | UNKNOWN | UNKNOWN | PARTIAL | UNKNOWN | OWN normalization/config | Arena Props config + TheSportsDB candidate | Need stable IDs, 12-sport coverage and a consistent approved sport-icon family |
...
| Team logos | IDN-007, ODD-002 | Critical | UNKNOWN | UNKNOWN | PARTIAL | UNKNOWN | N/A | TheSportsDB candidate | V2 documents `strBadge` and `strLogo`; exact NBA/all-sport coverage and trademark display/cache/resize rights remain gated |
...
| Player headshots | IDN-011, IDN-014 | Critical unless fallback approved | UNKNOWN | UNKNOWN | PARTIAL | UNKNOWN | N/A | TheSportsDB candidate | V2 documents thumb/cutout URLs and `strCreativeCommons`; NBA/all-sport coverage and per-asset rights remain gated |
...
| IDN-015 | TheSportsDB | Free V1 for mockups; paid V2 before users | V1 `all_sports.php`; V2 `/all/sports` / `strSportIconGreen` | PARTIAL | [API guide](https://www.thesportsdb.com/docs_api_guide) and [V2 OpenAPI](https://www.thesportsdb.com/api/spec/v2/openapi.yaml) | Free response verified for the limited first records; paid 12-sport fixture deferred | Revision/monthly target after upgrade | Current sport catalog | 30 requests/minute free; 100 developer; 120 small business | Development use now; paid-use review before users | Free mockup cache only; production confirmation pending | Proportional resize pending confirmation | TBD | $0 now; $9/month developer or $20/month small business later | 2026-09-03 | Prefer product-owned sport icons if one consistent visual family is required |
| IDN-007 | TheSportsDB | Free V1 for mockups; paid V2 before users | V1 `lookupteam.php?id=`; V2 `/lookup/team/{id}` / `strBadge`, `strLogo` | PARTIAL | [API guide](https://www.thesportsdb.com/docs_api_guide), [V2 OpenAPI](https://www.thesportsdb.com/api/spec/v2/openapi.yaml), and [terms](https://www.thesportsdb.com/docs_terms_of_use.php) | No | Revision/monthly target after upgrade | Entity records vary by sport/league | 30 requests/minute free; 100 developer; 120 small business | Development use now; paid attribution and third-party rights review before users | Free mockup cache only; production confirmation pending | Trademarked marks must remain as-is | TBD | $0 now; $9/month developer or $20/month small business later | 2026-09-03 | Capture limited free fixtures now; audit NBA coverage after upgrade |
| IDN-011 | TheSportsDB | Free V1 for mockups; paid V2 before users | V1 `lookupplayer.php?id=`; V2 `/lookup/player/{id}` | PARTIAL | [API guide](https://www.thesportsdb.com/docs_api_guide), [V2 OpenAPI](https://www.thesportsdb.com/api/spec/v2/openapi.yaml), and [terms](https://www.thesportsdb.com/docs_terms_of_use.php) | No | Revision/monthly target after upgrade | Entity records vary by sport/league | 30 requests/minute free; 100 developer; 120 small business | Development use now; paid attribution and per-asset license review before users | Free mockup cache only; production confirmation pending | Proportional resize pending confirmation | TBD | $0 now; $9/month developer or $20/month small business later | 2026-09-03 | `strThumb`, `strCutout` and `strCreativeCommons` documented; capture limited fixtures now |
...
| TheSportsDB | Free V1 development | $0 | No commitment | Most queries tightly result-limited; 30 requests/minute | N/A | N/A | Entity/event history varies | No required stream | Development/mockup use only; not the production rights decision | Community documentation only | [Official API guide](https://www.thesportsdb.com/docs_api_guide) and [terms](https://www.thesportsdb.com/docs_terms_of_use.php), checked 2026-09-03 |
| TheSportsDB | Premium V2 candidate | $9 developer or $20 small business published monthly | Monthly | 100 requests/minute developer; 120 requests/minute small business | TBD | TBD | Entity/event history varies | No required stream; media is revision-polled | Paid app/service use and source attribution are published; third-party/trademark scope and production cache/resize/retention still need written acceptance | Small Business lists dedicated email support | [Official API guide](https://www.thesportsdb.com/docs_api_guide), [pricing](https://www.thesportsdb.com/pricing), and [terms](https://www.thesportsdb.com/docs_terms_of_use.php), checked 2026-09-03 |
...
BALLDONTLIE NBA GOAT tier, $59 for The Odds API's 100K-credit plan and $0 for
TheSportsDB free V1 during mockup/testing, totaling $98.99 before infrastructure,
transaction fees, tax and overages. Upgrade TheSportsDB to the appropriate paid
V2 tier only after mockups/importer testing and before real users. The Odds API
is not sold per sport, but proof credits are restricted operationally to NBA.
ALL-ACCESS and maximum-volume upgrades require measured NBA proof results and
owner approval. These are budget assumptions; the evidence table above remains
authoritative for verified public price and plan terms.
